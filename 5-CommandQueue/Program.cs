...
namespace _5_CommandQueue
{
    internal static unsafe class Program
    {
        ...
        private static void WindowOnLoad()
        {
            ...
            wgpu.QueueOnSubmittedWorkDone(queue,new PfnQueueWorkDoneCallback((status, @void) =>
            {
            ...
            encoder = wgpu.DeviceCreateCommandEncoder(device, in commandEncoderDescriptor);
